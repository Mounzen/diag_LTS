...
import TimelineLogement from './TimelineLogement';
...
export default function LogementDetail({ detail, meta, user, onUpdated, onStart, onResume, canResume }) {
  ...
  return (
    <div className="panel detailPanel">
      ...
      <CaracteristiquesSection logement={logement} user={user} onUpdated={onUpdated} />
      <ConformiteSection logement={logement} user={user} />
      <TimelineLogement logementId={logement.id} />
